...
Imports Se2.ISCORSP.Client.GLCO.LTCAutomation.Processors

Namespace Se2.ISCORSP.Client.GLCO.LTCAutomation
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("LTCAutomation", New Processors.LTCAutomation))
