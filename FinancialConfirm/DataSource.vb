...
Namespace Se2.ISCORSP.Client.GLCO.FinancialConfirm.DataSource

#Region " FinancialConfirm "
...
#End Region
        ...
        Public Overrides Sub SetParameters()
            ...
            GroupID = "181"
            Cmpy = "CORSP"
            If cmdArgs.PROCESSOR = "FinancialConfirmRedirect" Then
                Flag = "U"
            End If
            ...
            Parms.Add(New SqlClient.SqlParameter("@ClientProcedure", "GLCO_FinancialConfirm"))
            Parms.Add(New SqlClient.SqlParameter("@Flag", Flag))
            'Parms.Add(New SqlClient.SqlParameter("@contract", "7280000073"))
        End Sub
    End Class
