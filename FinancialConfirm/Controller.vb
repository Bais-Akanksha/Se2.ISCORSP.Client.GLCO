...
Imports Se2.ISCORSP.Client.GLCO.FinancialConfirm.Processors

Namespace Se2.ISCORSP.Client.GLCO.FinancialConfirm
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("FinancialConfirm", New Processors.FinancialConfirm))
            Processors.Add(New ProcessorNV("FinancialConfirmRedirect", New Processors.FinancialConfirmRedirect))
        End Sub
