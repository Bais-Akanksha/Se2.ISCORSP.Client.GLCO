...
Namespace Se2.ISCORSP.Client.GLCO.CostBasisLetter.SourceLayouts
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property ZIP_SUFFIX As String
            ...
            End Get
        End Property
        Public ReadOnly Property AMT As Decimal
            Get
                Return Convert.ToDecimal(Values(FieldList.AMT))
            End Get
        End Property
        Public ReadOnly Property AMT_RECD As Decimal
            Get
                Return Convert.ToDecimal(Values(FieldList.AMT_RECD))
            End Get
        End Property
