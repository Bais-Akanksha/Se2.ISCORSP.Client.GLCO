...
Namespace Se2.ISCORSP.Client.GLCO.CostBasisLetter.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("POL_SERVICE_DESC", "S:Cost Basis Letter"))
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            Fields = New List(Of FieldDef)
            With Fields
                .Add(New FieldDef("EXC_CONT", "CONT"))
                .Add(New FieldDef("EXC_COMP_ACCT_NUM", "SOURCE_POLICY"))
                .Add(New FieldDef("EXC_COMP_NAME", "TSF_COMPANY_NAME"))
                .Add(New FieldDef("EXC_COMP_ADDR_LINE1", "ADDRESS1"))
                .Add(New FieldDef("EXC_COMP_ADDR_LINE2", "ADDRESS2"))
                .Add(New FieldDef("EXC_COMP_ADDR_LINE3", "ADDRESS3"))
                .Add(New FieldDef("EXC_COMP_CITY", "CITY"))
                .Add(New FieldDef("EXC_COMP_STATE", "STATE_CODE"))
                .Add(New FieldDef("EXC_COMP_ZIP", "F:ZIP_CODE"))
                .Add(New FieldDef("EXC_COMP_AMT", 0, FieldType.Number, "0.00", "F:COMP_AMT"))
            End With
        End Sub
#End Region

#Region " PROPERTIES "
        Public ReadOnly Property EXC_CONT As FieldDef
            Get
                Return Fields(FieldList.EXC_CONT)
            End Get
        End Property
        Public ReadOnly Property EXC_COMP_ACCT_NUM As FieldDef
            Get
                Return Fields(FieldList.EXC_COMP_ACCT_NUM)
            End Get
        End Property
        Public ReadOnly Property EXC_COMP_NAME As FieldDef
            Get
                Return Fields(FieldList.EXC_COMP_NAME)
            End Get
        End Property
        Public ReadOnly Property EXC_COMP_ADDR_LINE1 As FieldDef
            Get
                Return Fields(FieldList.EXC_COMP_ADDR_LINE1)
            End Get
        End Property
        Public ReadOnly Property EXC_COMP_ADDR_LINE2 As FieldDef
            Get
                Return Fields(FieldList.EXC_COMP_ADDR_LINE2)
            End Get
        End Property
        Public ReadOnly Property EXC_COMP_ADDR_LINE3 As FieldDef
            Get
                Return Fields(FieldList.EXC_COMP_ADDR_LINE3)
            End Get
        End Property
        Public ReadOnly Property EXC_COMP_CITY As FieldDef
            Get
                Return Fields(FieldList.EXC_COMP_CITY)
            End Get
        End Property
        Public ReadOnly Property EXC_COMP_STATE As FieldDef
            Get
                Return Fields(FieldList.EXC_COMP_STATE)
            End Get
        End Property
        Public ReadOnly Property EXC_COMP_ZIP As FieldDef
            Get
                Return Fields(FieldList.EXC_COMP_ZIP)
            End Get
        End Property
        Public ReadOnly Property EXC_COMP_AMT As FieldDef
            Get
                Return Fields(FieldList.EXC_COMP_AMT)
            End Get
        End Property
