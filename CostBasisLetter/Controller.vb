...
Imports Se2.ISCORSP.Client.GLCO.CostBasisLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.CostBasisLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("CostBasisLetter", New Processors.CostBasisLetter))
            Processors.Add(New ProcessorNV("CostBasisLetterRedirect", New Processors.CostBasisLetterRedirect))
        End Sub
