...
Imports Se2.ISCORSP.Client.GLCO.FIAPolicyPage.Processors


Namespace Se2.ISCORSP.Client.GLCO.FIAPolicyPage
    Public Class Controller
        ...
        Public Sub New()
            ...
            Processors.Add(New ProcessorNV("POLICYPAGE", New Processors.POLICYPAGE))
            ...
            For Each NVProcessor As ProcessorNV In Processors
                Try
                    ...
                    If NVProcessor.Value.Args.ProcessedRecords > 0 Then
                        Console.WriteLine("POLICY_COUNT=" + Convert.ToString(NVProcessor.Value.Args.Accumulators("ROW_DATA_COUNT")))
                        Console.WriteLine("TRACKING_ID=" + System.Guid.NewGuid.ToString)
                    End If
