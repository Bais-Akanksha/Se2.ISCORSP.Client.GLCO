...
Namespace Se2.ISCORSP.Client.GLCO.FIAPolicyPage.DataSource

#Region " FIAPolicyPage "
...
#End Region
        ...
        Public Overrides Sub SetParameters()
            ...
            GroupID = "181"
            Cmpy = "CORSP"
            If cmdArgs.PROCESSOR = "POLICYPAGE" Then
                Flag = "U"
            End If
            ...
            Parms.Add(New SqlClient.SqlParameter("@ClientProcedure", "GLCO_FIAPolicyPage"))
