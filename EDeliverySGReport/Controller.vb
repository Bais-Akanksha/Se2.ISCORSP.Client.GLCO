...
Imports Se2.ISCORSP.Client.GLCO.EDeliverySGReport.Processors

Namespace Se2.ISCORSP.Client.GLCO.EDeliverySGReport
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("EDelivery", New Processors.EDeliverySGReport))
