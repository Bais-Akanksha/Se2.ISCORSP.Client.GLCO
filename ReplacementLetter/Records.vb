...
Namespace Se2.ISCORSP.Client.GLCO.ReplacementLetter.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("POL_SERVICE_DESC", "S:Replacement Letter"))
                ...
                .Add(New FieldDef("POL_DOC_TYPE", "S:REPLTR"))
