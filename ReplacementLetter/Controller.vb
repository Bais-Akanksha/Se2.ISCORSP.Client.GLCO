...
Imports Se2.ISCORSP.Client.GLCO.ReplacementLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.ReplacementLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("ReplacementLetter", New Processors.ReplacementLetter))
            Processors.Add(New ProcessorNV("ReplacementLetterRedirect", New Processors.ReplacementLetterRedirect))
        End Sub
