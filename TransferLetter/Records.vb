...
Namespace Se2.ISCORSP.Client.GLCO.TransferLetter.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
				...
				.Add(New FieldDef("Service_Desc", "S:Transfer Letter"))
...
#Region " Exchange "
    ...
    Public Class Exchange
        ...
        Private Shadows Enum FieldList
            Contract_Num
            Transfer_Comp_Acct_Num
            Transfer_Comp_Name
            Transfer_Comp_Addr_Line_1
            Transfer_Comp_Addr_Line_2
            Transfer_Comp_Addr_Line_3
            Transfer_Comp_City
            Transfer_Comp_State
            Transfer_Comp_Zip
            Transfer_Comp_Er_Num
            Exc_Method_ID
            Exc_Method_Desc
            Exc_Fax_Number
...
#Region " CONSTRUCTORS "
        Public Sub New()
            MyBase.New()
            Initialize()
            Me.NodeName = "Exchange"
            Me.NodeParent = "Exchanges"
        End Sub
        ...
        Private Sub Initialize()
            ...
            With Fields
                .Add(New FieldDef("Contract_Num", "CONT"))
                .Add(New FieldDef("Transfer_Comp_Acct_Num", "SOURCE_POLICY"))
                .Add(New FieldDef("Transfer_Comp_Name", "TSF_COMPANY_NAME"))
                .Add(New FieldDef("Transfer_Comp_Addr_Line_1", "ADDRESS1"))
                .Add(New FieldDef("Transfer_Comp_Addr_Line_2", "ADDRESS2"))
                .Add(New FieldDef("Transfer_Comp_Addr_Line_3", "ADDRESS3"))
                .Add(New FieldDef("Transfer_Comp_City", "CITY"))
                .Add(New FieldDef("Transfer_Comp_State", "STATE_CODE"))
                .Add(New FieldDef("Transfer_Comp_Zip", "F:ZIP_CODE"))
                .Add(New FieldDef("Transfer_Comp_Er_Num", "ER_NUM"))
                .Add(New FieldDef("Exc_Method_ID", "LOA_DLVRY_MTD_ID"))
                .Add(New FieldDef("Exc_Method_Desc", "LOA_DLVRY_MTD_DESC"))
                .Add(New FieldDef("Exc_Fax_Number", "LOA_DLVRY_FAX"))
...
#Region " PROPERTIES "
        Public ReadOnly Property Contract_Num As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property Transfer_Comp_Acct_Num As FieldDef
            Get
                Return Fields(FieldList.Transfer_Comp_Acct_Num)
            End Get
        End Property
        Public ReadOnly Property Transfer_Comp_Name As FieldDef
            Get
                Return Fields(FieldList.Transfer_Comp_Name)
            End Get
        End Property
        Public ReadOnly Property Transfer_Comp_Addr_Line_1 As FieldDef
            Get
                Return Fields(FieldList.Transfer_Comp_Addr_Line_1)
            End Get
        End Property
        Public ReadOnly Property Transfer_Comp_Addr_Line_2 As FieldDef
            Get
                Return Fields(FieldList.Transfer_Comp_Addr_Line_2)
            End Get
        End Property
        Public ReadOnly Property Transfer_Comp_Addr_Line_3 As FieldDef
            Get
                Return Fields(FieldList.Transfer_Comp_Addr_Line_3)
            End Get
        End Property
        Public ReadOnly Property Transfer_Comp_City As FieldDef
            Get
                Return Fields(FieldList.Transfer_Comp_City)
            End Get
        End Property
        Public ReadOnly Property Transfer_Comp_State As FieldDef
            Get
                Return Fields(FieldList.Transfer_Comp_State)
            End Get
        End Property
        Public ReadOnly Property Transfer_Comp_Zip As FieldDef
            Get
                Return Fields(FieldList.Transfer_Comp_Zip)
            End Get
        End Property
        Public ReadOnly Property Transfer_Comp_Er_Num As FieldDef
            Get
                Return Fields(FieldList.Transfer_Comp_Er_Num)
            End Get
        End Property
        Public ReadOnly Property Exc_Method_ID As FieldDef
            Get
                Return Fields(FieldList.Exc_Method_ID)
            End Get

        End Property
        Public ReadOnly Property Exc_Fax_Method_Desc As FieldDef
            Get
                Return Fields(FieldList.Exc_Method_Desc)
            End Get

        End Property
        Public ReadOnly Property Exc_Fax_Number As FieldDef
            Get
                Return Fields(FieldList.Exc_Fax_Number)
            End Get
