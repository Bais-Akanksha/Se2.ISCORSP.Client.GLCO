...
Namespace Se2.ISCORSP.Client.GLCO.TransferLetter.SourceLayouts
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property CONT As String
            ...
            End Get
        End Property
        Public ReadOnly Property SOURCE_POLICY As String
            Get
                Return Values(FieldList.SOURCE_POLICY)
            End Get
        End Property
        Public ReadOnly Property TSF_COMPANY_NAME As String
            Get
                Return Values(FieldList.TSF_COMPANY_NAME)
            End Get
        End Property
        Public ReadOnly Property ADDRESS_ID As String
            Get
        ...
        Public ReadOnly Property ZIP_SUFFIX As String
            ...
            End Get
        End Property
        Public ReadOnly Property ER_NUM As String
            Get
                Return Values(FieldList.ER_NUM)
            End Get
        End Property
        Public ReadOnly Property LOA_DLVRY_MTD_ID As String
            Get
                Return Values(FieldList.LOA_DLVRY_MTD_ID)
            End Get
        End Property
        Public ReadOnly Property LOA_DLVRY_MTD_DESC As String
            Get
                Return Values(FieldList.LOA_DLVRY_MTD_DESC)
            End Get
        End Property
        Public ReadOnly Property LOA_DLVRY_FAX As String
            Get
                Return Values(FieldList.LOA_DLVRY_FAX)
            End Get
        End Property
