...
Namespace Se2.ISCORSP.Client.GLCO.TransferLetter.DataSource

#Region " TransferLetter "
...
#End Region
        ...
        Public Overrides Sub SetParameters()
            ...
            Select Case cmdArgs.PROCESSOR
                Case "TransferLetterRedirect"
                    Flag = "U"
                Case "TransferLetterFax"
                    Flag = "B"
            End Select
            ...
            Parms.Add(New SqlClient.SqlParameter("@ClientProcedure", "GLCO_TransferLetter"))
