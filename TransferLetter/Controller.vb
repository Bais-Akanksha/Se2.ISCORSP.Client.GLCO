...
Imports Se2.ISCORSP.Client.GLCO.TransferLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.TransferLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("TransferLetter", New Processors.TransferLetter))
            Processors.Add(New ProcessorNV("TransferLetterRedirect", New Processors.TransferLetterRedirect))
            Processors.Add(New ProcessorNV("TransferLetterFax", New Processors.TransferLetterFax))
        End Sub
