...
Namespace Se2.ISCORSP.Client.GLCO.FIAADL60DayLetter.CLM
...
#Region " POPULATION FUNCTIONS "
        ...
        Public Function TrackingID(ByVal value As Se2Args) As Object
            ...
            Return retval
        End Function
        Public Function Get_Start_Date(ByVal value As Se2Args) As String
            Dim year As Int32
            Dim retVal As String = ""
            Dim startDate As Date
            year = value.SourceHeader.CYCLE_DATE.Year
            startDate = New DateTime(year, Se2Source.ISSUE_DATE.Month, Se2Source.ISSUE_DATE.Day)

            retVal = CType(DateAdd(DateInterval.Day, -25, startDate), String)
...
#Region " POPULATION FUNCTIONS "
        ...
        Public Function GetEmailAddress(ByVal value As Se2Args) As Object
            ...
            If CBool(Se2Source.MAIL_FLAG) Then
                ...
                StoreEmail.addParms("@DocumentType", "ADL60")
