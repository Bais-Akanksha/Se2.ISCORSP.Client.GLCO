...
Imports Se2.ISCORSP.Client.GLCO.FIAADL60DayLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.FIAADL60DayLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("FIAADL60DayLetter", New Processors.FIAADL60DayLetter))
            Processors.Add(New ProcessorNV("FIAADL60DayLetterRedirect", New Processors.FIAADL60DayLetterRedirect))
        End Sub
