...
Namespace Se2.ISCORSP.Client.GLCO.FIAADL60DayLetter.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("POL_SERVICE_DESC", "S:60 day Recertification Letter"))
                ...
                .Add(New FieldDef("POL_DOC_TYPE", "S:ADL60"))
                .Add(New FieldDef("POL_START_DATE", "", FieldType.Date, "yyyy-MM-dd", "F:Get_Start_Date"))
            End With
        End Sub
#End Region
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property POL_DOC_TYPE As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property POL_START_DATE As FieldDef
            Get
                Return Fields(FieldList.POL_START_DATE)
            End Get
        End Property
#End Region
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("ADDR_CNTRY_CODE", "CTRY_CODE"))
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property ADDR_ZIP As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property ADDR_CNTRY_CODE As FieldDef
            Get
                Return Fields(FieldList.ADDR_CNTRY_CODE)
            End Get
        End Property
