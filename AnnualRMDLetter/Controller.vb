...
Imports Se2.ISCORSP.Client.GLCO.AnnualRMDLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.AnnualRMDLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("AnnualRMDLetter", New Processors.AnnualRMDLetter))
            Processors.Add(New ProcessorNV("AnnualRMDLetterRedirect", New Processors.AnnualRMDLetterRedirect))
        End Sub
