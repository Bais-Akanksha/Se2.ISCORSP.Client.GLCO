...
Namespace Se2.ISCORSP.Client.GLCO.AnnualRMDLetter.DataSource
...
#End Region
        ...
        Public Overrides Sub SetParameters()
            ...
            GroupID = "181"
            Cmpy = "CORSP"
            If cmdArgs.PROCESSOR = "AnnualRMDLetterRedirect" Then
                Flag = "U"
            End If
            ...
            Parms.Add(New SqlClient.SqlParameter("@ClientProcedure", "GLCO_AnnualRMDLetter"))
