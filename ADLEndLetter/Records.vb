...
Namespace Se2.ISCORSP.Client.GLCO.ADLEndLetter.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("POL_SERVICE_DESC", "S:EndLetter"))
                ...
                '.Add(New FieldDef("POL_LIFETIME_PYMNT_AMT", "GWB_ANNUAL_LIMIT"))
