...
Imports Se2.ISCORSP.Client.GLCO.ADLEndLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.ADLEndLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("ADLEndLetter", New Processors.ADLEndLetter))
            Processors.Add(New ProcessorNV("ADLEndLetterRedirect", New Processors.ADLEndLetterRedirect))
        End Sub
