...
Namespace Se2.ISCORSP.Client.GLCO.FixedAnnivStmt.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("POL_SERVICE_DESC", "F:SERVICE_DESC"))
                ...
                .Add(New FieldDef("POL_MIN_GUAR_RATE", 0, FieldType.Number, "0.00", "MIN_GUAR_RATE"))
                .Add(New FieldDef("POL_RELATED_CONT", "RELATED_CONT"))
            End With
        End Sub
#End Region
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property POL_ISSUE_DATE As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property POL_MIN_GUAR_RATE As FieldDef
            Get
                Return Fields(FieldList.POL_MIN_GUAR_RATE)
            End Get
        End Property
        Public ReadOnly Property POL_RELATED_CONT As FieldDef
            Get
                Return Fields(FieldList.POL_RELATED_CONT)
            End Get
        End Property
#End Region
...
#Region " PolValue "
    ...
    Public Class PolValue
        ...
        Private Shadows Enum FieldList
            ...
            PVAL_GUAR_PERIOD
            PVAL_LTC_EXTENDED_BNFT
            PVAL_LTC_MAX_DLY_BNFT
            PVAL_LTC_MTH_PREM_AMT
            PVAL_LTC_WAIVER_FLAG
            PVAL_LTC_WITHD_PREM_AMT
            PVAL_LTC_WITHD_BNFT
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("PVAL_CASH_VAL", "CASH_VAL"))
                .Add(New FieldDef("PVAL_DEATH_BNFT_VAL", "ANNIV_DEATH_BNFT"))
                ...
                .Add(New FieldDef("PVAL_GUAR_PERIOD", "GUAR_PERIOD"))
                .Add(New FieldDef("PVAL_LTC_EXTENDED_BNFT", "F:LTC_RIDER_BENEFIT"))
                .Add(New FieldDef("PVAL_LTC_MAX_DLY_BNFT", "F:LTC_DAILY_BNFT"))
                .Add(New FieldDef("PVAL_LTC_MTH_PREM_AMT", "CURR_LTC_PREM_AMT"))
                .Add(New FieldDef("PVAL_LTC_WAIVER_FLAG", "LTC_CLAIM_WAIVER"))
                .Add(New FieldDef("PVAL_LTC_WITHD_PREM_AMT", "F:LTC_WITHD_PREM"))
                .Add(New FieldDef("PVAL_LTC_WITHD_BNFT", "LTC_PYTD_WITHD_BNFT"))
                .Add(New FieldDef("PVAL_LTC_RIDER_FLAG_ANNUICARE", "F:LTC_RIDER_FLAG_ANNUICARE"))
            End With
        End Sub
#End Region
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property PVAL_BEGIN_ACCUM_VAL As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property PVAL_GUAR_PERIOD As FieldDef
            Get
                Return Fields(FieldList.PVAL_GUAR_PERIOD)
            End Get
        End Property
        Public ReadOnly Property PVAL_LTC_EXTENDED_BNFT As FieldDef
            Get
                Return Fields(FieldList.PVAL_LTC_EXTENDED_BNFT)
            End Get
        End Property
        Public ReadOnly Property PVAL_LTC_MAX_DLY_BNFT As FieldDef
            Get
                Return Fields(FieldList.PVAL_LTC_MAX_DLY_BNFT)
            End Get
        End Property
        Public ReadOnly Property PVAL_LTC_MTH_PREM_AMT As FieldDef
            Get
                Return Fields(FieldList.PVAL_LTC_MTH_PREM_AMT)
            End Get
        End Property
        Public ReadOnly Property PVAL_LTC_WAIVER_FLAG As FieldDef
            Get
                Return Fields(FieldList.PVAL_LTC_WAIVER_FLAG)
            End Get
        End Property
        Public ReadOnly Property PVAL_LTC_WITHD_PREM_AMT As FieldDef
            Get
                Return Fields(FieldList.PVAL_LTC_WITHD_PREM_AMT)
            End Get
        End Property
        Public ReadOnly Property PVAL_LTC_WITHD_BNFT As FieldDef
            Get
                Return Fields(FieldList.PVAL_LTC_WITHD_BNFT)
            End Get
        End Property
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("FND_ADJUSTED_RATE", 0, FieldType.Number, "0.00", "ADJUSTED_RATE"))
            End With
        End Sub
#End Region
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property FND_INT_RATE As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property FND_ADJUSTED_RATE As FieldDef
            Get
                Return Fields(FieldList.FND_ADJUSTED_RATE)
            End Get
        End Property
#End Region
