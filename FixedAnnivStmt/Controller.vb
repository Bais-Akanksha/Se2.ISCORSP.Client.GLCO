...
Imports Se2.ISCORSP.Client.GLCO.FixedAnnivStmt.Processors

Namespace Se2.ISCORSP.Client.GLCO.FixedAnnivStmt
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("FixedAnnivStmt", New Processors.FixedAnnivStmt))
            Processors.Add(New ProcessorNV("FixedAnnivStmtRedirect", New Processors.FixedAnnivStmtRedirect))
        End Sub
