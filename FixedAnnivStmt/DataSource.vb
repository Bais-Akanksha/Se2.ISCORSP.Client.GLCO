...
Namespace Se2.ISCORSP.Client.GLCO.FixedAnnivStmt.DataSource
...
#End Region
        ...
        Public Overrides Sub SetParameters()
            ...
            GroupID = "181"
            Cmpy = "CORSP"
            If cmdArgs.PROCESSOR = "FixedAnnivStmtRedirect" Then
                Flag = "U"
            End If
            ...
            Parms.Add(New SqlClient.SqlParameter("@ClientProcedure", "GLCO_FixedAnnivStmt"))
            Parms.Add(New SqlClient.SqlParameter("@Flag", Flag))
            'Parms.Add(New SqlClient.SqlParameter("@contract", "K01032926"))
        End Sub
    End Class
