...
Imports Se2.ISCORSP.Client.GLCO.EDelivery.Processors

Namespace Se2.ISCORSP.Client.GLCO.EDelivery
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("EDelivery", New Processors.EDelivery))
