...
Imports Se2.ISCORSP.Client.GLCO.RenewalLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.RenewalLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("RenewalLetter", New Processors.RenewalLetter))
            Processors.Add(New ProcessorNV("RenewalLetterRedirect", New Processors.RenewalLetterRedirect))
        End Sub
