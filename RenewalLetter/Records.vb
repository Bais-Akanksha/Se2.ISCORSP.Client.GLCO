...
Namespace Se2.ISCORSP.Client.GLCO.RenewalLetter.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("POL_SERVICE_DESC", "S:Renewal Letter"))
                ...
                .Add(New FieldDef("POL_NEXT_FIXED_RENEW_DATE", "", FieldType.Date, "yyyy-MM-dd", "RENEWAL_DATE"))
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property POL_TRACKING_ID As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property POL_NEXT_FIXED_RENEW_DATE As FieldDef
            Get
                Return Fields(FieldList.POL_NEXT_FIXED_RENEW_DATE)
            End Get
        End Property
...
#Region " CONSTRUCTORS "
        Public Sub New()
            MyBase.New()
            Initialize()
            Me.NodeName = "RenewFund"
            Me.NodeParent = "RenewFunds"
        End Sub

        Private Sub Initialize()
            Fields = New List(Of FieldDef)
            With Fields
                .Add(New FieldDef("RFN_CONT", "CONT"))
                .Add(New FieldDef("RFN_ACC_CODE", "ACC_CODE"))
                .Add(New FieldDef("RFN_DIV_CODE", "DIV_CODE"))
                .Add(New FieldDef("RFN_FUND_MKTG_NAME", "MRKT_FUND_NAME"))
                .Add(New FieldDef("RFN_PART_RATE", "F:PARTICIPATION_RATE"))
                .Add(New FieldDef("RFN_CAP_RATE", "F:INDEX_CAP_RATE"))
                .Add(New FieldDef("RFN_INT_RATE", "F:INTEREST_RATE"))
                .Add(New FieldDef("RFN_FUND_RATE", 0, FieldType.Number, "0.00", "FUND_FEE_RATE"))
                .Add(New FieldDef("RFN_FUND_SORT_ORDER", "F:CORRO_SORT_ORDER"))
...
#Region " PROPERTIES "
        Public ReadOnly Property RFN_CONT As FieldDef
            Get
                Return Fields(FieldList.RFN_CONT)
            End Get
        End Property
        Public ReadOnly Property RFN_ACC_CODE As FieldDef
            Get
                Return Fields(FieldList.RFN_ACC_CODE)
            End Get
        End Property
        Public ReadOnly Property RFN_DIV_CODE As FieldDef
            Get
                Return Fields(FieldList.RFN_DIV_CODE)
            End Get
        End Property
        Public ReadOnly Property RFN_FUND_MKTG_NAME As FieldDef
            Get
                Return Fields(FieldList.RFN_FUND_MKTG_NAME)
            End Get
        End Property
        Public ReadOnly Property RFN_PART_RATE As FieldDef
            Get
                Return Fields(FieldList.RFN_PART_RATE)
            End Get
        End Property
        Public ReadOnly Property RFN_CAP_RATE As FieldDef
            Get
                Return Fields(FieldList.RFN_CAP_RATE)
            End Get
        End Property
        Public ReadOnly Property RFN_INT_RATE As FieldDef
            Get
                Return Fields(FieldList.RFN_INT_RATE)
            End Get
        End Property
        Public ReadOnly Property RFN_FUND_RATE As FieldDef
            Get
                Return Fields(FieldList.RFN_FUND_RATE)
            End Get
        End Property
        Public ReadOnly Property RFN_FUND_SORT_ORDER As FieldDef
            Get
                Return Fields(FieldList.RFN_FUND_SORT_ORDER)
            End Get
        End Property
