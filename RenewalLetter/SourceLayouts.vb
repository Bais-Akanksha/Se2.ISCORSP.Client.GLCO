...
Namespace Se2.ISCORSP.Client.GLCO.RenewalLetter.SourceLayouts
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property PRCSSNG_CO As String
            ...
            End Get
        End Property
        Public ReadOnly Property RENEWAL_DATE As String
            Get
                Return Values(FieldList.RENEWAL_DATE)
            End Get
        End Property
...
#Region " FEILD ARRAY ENUM "
        Public Shadows Enum FieldList
            ...
            INT_RATE_ID
            INT_RATE_ID2
            INTEREST_RATE2  'Participation Rate
            INT_RATE_DATE
            MRKT_FUND_NAME
            FUND_START_DATE
            FUND_END_DATE
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property DURATION As String
            Get
                Return Values(FieldList.DURATION)
            End Get
        End Property
        Public ReadOnly Property INTEREST_RATE As String
            Get
                Return Values(FieldList.INTEREST_RATE)
            End Get
        End Property
        Public ReadOnly Property INDEX_CAP_ID As String
            Get
                Return Values(FieldList.INDEX_CAP_ID)
            End Get
        End Property
        Public ReadOnly Property INDEX_CAP As String
            Get
                Return Values(FieldList.INDEX_CAP)
            End Get
        End Property
        Public ReadOnly Property INT_RATE_ID As String
            Get
                Return Values(FieldList.INT_RATE_ID)
            End Get
        End Property
        Public ReadOnly Property INT_RATE_ID2 As String
            Get
                Return Values(FieldList.INT_RATE_ID2)
            End Get
        End Property
        Public ReadOnly Property INTEREST_RATE2 As String
            Get
                Return Values(FieldList.INTEREST_RATE2)
            End Get
        End Property
        Public ReadOnly Property INT_RATE_DATE As String
            Get
                Return Values(FieldList.INT_RATE_DATE)
            End Get
        End Property
        Public ReadOnly Property MRKT_FUND_NAME As String
            ...
            End Get
        End Property
        Public ReadOnly Property FUND_START_DATE As String
            Get
                Return Values(FieldList.FUND_START_DATE)
            End Get
        End Property
        Public ReadOnly Property FUND_END_DATE As String
            Get
                Return Values(FieldList.FUND_END_DATE)
            End Get
        End Property
        Public ReadOnly Property FUND_FEE_RATE As String
            Get
                Return Values(FieldList.FUND_FEE_RATE)
            End Get
        End Property
        Public ReadOnly Property TYPE As String
            Get
                Return Values(FieldList.TYPE)
            End Get
        End Property
