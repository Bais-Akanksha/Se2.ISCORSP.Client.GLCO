...
Namespace Se2.ISCORSP.Client.GLCO.BRCCEmailNotification.DataSource
...
#End Region
        ...
        Public Overrides Sub SetParameters()
            ...
            GroupID = "181"
            Cmpy = "CORSP"
            'If cmdArgs.PROCESSOR = "BeneChangeLetterRedirect" Then
            '    Flag = "U"
            'End If
            ...
            Parms.Add(New SqlClient.SqlParameter("@ClientProcedure", "GLCO_BRCCEmailNotification"))
            Parms.Add(New SqlClient.SqlParameter("@Flag", Flag))
            'Parms.Add(New SqlClient.SqlParameter("@contract", "7320000241"))
        End Sub
    End Class
