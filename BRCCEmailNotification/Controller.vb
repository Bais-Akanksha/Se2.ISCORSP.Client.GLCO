...
Imports Se2.ISCORSP.Client.GLCO.BRCCEmailNotification.Processors

Namespace Se2.ISCORSP.Client.GLCO.BRCCEmailNotification
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("BRCCEmailNotification", New Processors.BRCCEmailNotification))
