...
Imports Se2.ISCORSP.Client.GLCO.AnnualRMDAgentLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.AnnualRMDAgentLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("AnnualRMDAgentLetter", New Processors.AnnualRMDAgentLetter))
            Processors.Add(New ProcessorNV("AnnualRMDAgentLetterRedirect", New Processors.AnnualRMDAgentLetterRedirect))
        End Sub
