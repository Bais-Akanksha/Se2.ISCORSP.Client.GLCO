...
Namespace Se2.ISCORSP.Client.GLCO.DailyRMDLetter.Records
...
#Region " CONSTRUCTORS "
		...
		Private Sub Initialize()
			...
			With Fields
                ...
                .Add(New FieldDef("Service_Desc", "S:Minimum Distribution Letter"))
                ...
                .Add(New FieldDef("Processing_Company", "PRODUCT_CO"))
