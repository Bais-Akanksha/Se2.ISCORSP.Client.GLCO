...
Namespace Se2.ISCORSP.Client.GLCO.DailyRMDLetter.DataSource
...
#End Region
            ...
            currCycleDate = cmdArgs.CYCLEDATE
						GroupID = "181"
						Cmpy = "CORSP"
			If cmdArgs.PROCESSOR = "DailyRMDLetterRedirect" Then
                Flag = "U"
            End If
			...
			Parms.Add(New SqlClient.SqlParameter("@ClientProcedure", "GLCO_DailyRMDLetter"))
