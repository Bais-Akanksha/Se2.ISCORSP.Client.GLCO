...
Imports Se2.ISCORSP.Client.GLCO.DailyRMDLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.DailyRMDLetter
		...
		Public Class Controller
				...
				Public Sub New()
						MyBase.New()
			Processors.Add(New ProcessorNV("DailyRMDLetter", New Processors.DailyRMDLetter))
            Processors.Add(New ProcessorNV("DailyRMDLetterRedirect", New Processors.DailyRMDLetterRedirect))
        End Sub
