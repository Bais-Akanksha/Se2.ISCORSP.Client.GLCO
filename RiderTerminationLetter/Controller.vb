...
Imports Se2.ISCORSP.Client.GLCO.RiderTerminationLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.RiderTerminationLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("RiderTerminationLetter", New Processors.RiderTerminationLetter))
            Processors.Add(New ProcessorNV("RiderTerminationLetterRedirect", New Processors.RiderTerminationLetterRedirect))
        End Sub
