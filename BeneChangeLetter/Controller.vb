...
Imports Se2.ISCORSP.Client.GLCO.BeneChangeLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.BeneChangeLetter
		...
		Public Class Controller
				...
				Public Sub New()
						MyBase.New()
			Processors.Add(New ProcessorNV("BeneChangeLetter", New Processors.BeneChangeLetter))
            Processors.Add(New ProcessorNV("BeneChangeLetterRedirect", New Processors.BeneChangeLetterRedirect))
        End Sub
