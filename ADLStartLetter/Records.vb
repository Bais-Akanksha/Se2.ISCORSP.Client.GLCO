...
Namespace Se2.ISCORSP.Client.GLCO.ADLStartLetter.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("POL_SERVICE_DESC", "S:ADLStart"))
                ...
                .Add(New FieldDef("POL_LIFETIME_PYMNT_AMT", "F:ANNUAL_LIMIT_PYMT"))
                .Add(New FieldDef("POL_PREM_MODE", "F:GetPayMode"))
                .Add(New FieldDef("POL_BEN_START_DATE", "", FieldType.Date, "yyyy-MM-dd", "ADDTL_BEN_START_DATE"))
                '.Add(New FieldDef("POL_RECERT_DATE", "F:GetCertifyDate"))
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property POL_TRACKING_ID As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property POL_LIFETIME_PYMNT_AMT As FieldDef
            Get
                Return Fields(FieldList.POL_LIFETIME_PYMNT_AMT)
            End Get
        End Property
        Public ReadOnly Property POL_PREM_MODE As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property POL_BEN_START_DATE As FieldDef
            Get
                Return Fields(FieldList.POL_BEN_START_DATE)
            End Get
        End Property
        'Public ReadOnly Property POL_RECERT_DATE As FieldDef
        '    Get
        '        Return Fields(FieldList.POL_RECERT_DATE)
        '    End Get
        'End Property
