...
Imports Se2.ISCORSP.Client.GLCO.ADLStartLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.ADLStartLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("ADLStartLetter", New Processors.ADLStartLetter))
            Processors.Add(New ProcessorNV("ADLStartLetterRedirect", New Processors.ADLStartLetterRedirect))
        End Sub
