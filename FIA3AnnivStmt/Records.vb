...
Namespace Se2.ISCORSP.Client.GLCO.FIA3AnnivStmt.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("PVAL_END_ACCUM_VAL", 0, FieldType.Number, "0.00", "END_ACCUM_VAL"))
                .Add(New FieldDef("PVAL_CASH_VAL", 0, FieldType.Number, "0.00", "CASH_VAL"))
                ...
                .Add(New FieldDef("PVAL_PREM_BONUS", 0, FieldType.Number, "0.00", "PVAL_PREM_BONUS"))
                ...
                .Add(New FieldDef("PVAL_PREM_BONUS_RECAPTURE", 0, FieldType.Number, "0.00", "CRED_ENH")) ''  PREM_BONUS_RECAPTURE
                .Add(New FieldDef("PVAL_PYTD_FEES", 0, FieldType.Number, "0.00", "PYTD_FEES"))
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property PVAL_BONUS_INT_AMT As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property PVAL_PREM_BONUS_RECAPTURE As FieldDef
            Get
                Return Fields(FieldList.PVAL_PREM_BONUS_RECAPTURE)
            End Get
        End Property
        Public ReadOnly Property PVAL_PYTD_FEES As FieldDef
            Get
                Return Fields(FieldList.PVAL_PYTD_FEES)
            End Get
        End Property
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("FND_FUND_SORT_ORDER", "F:CORRO_SORT_ORDER"))
                .Add(New FieldDef("NEXT_FND_INT_RATE", "F:NEXT_INTEREST_RATE"))  '--LGP-22340 adding for ADJUSTED_RATE for current date Txn Type = 25
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property FND_ORIG_DEPST_DATE As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property FND_FUND_SORT_ORDER As FieldDef
            Get
                Return Fields(FieldList.FND_FUND_SORT_ORDER)
            End Get
        End Property

        '--LGP-22340 adding for ADJUSTED_RATE for current date Txn Type = 25
        Public ReadOnly Property NEXT_FND_INT_RATE As FieldDef
            Get
                Return Fields(FieldList.NEXT_FND_INT_RATE)
            End Get
        End Property
#End Region
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("PAF_BEGIN_BAL", 0, FieldType.Number, "0.00", "F:GET_PRIOR_FUND_BAL"))
                ...
                .Add(New FieldDef("PAF_FUND_SORT_ORDER", "F:CORRO_SORT_ORDER"))
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property PAF_ORIG_DEPST_DATE As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property PAF_FUND_SORT_ORDER As FieldDef
            Get
                Return Fields(FieldList.PAF_FUND_SORT_ORDER)
            End Get
        End Property
