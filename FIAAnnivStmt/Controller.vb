...
Imports Se2.ISCORSP.Client.GLCO.FIAAnnivStmt.Processors

Namespace Se2.ISCORSP.Client.GLCO.FIAAnnivStmt
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("FIAAnnivStmt", New Processors.FIAAnnivStmt))
            Processors.Add(New ProcessorNV("FIAAnnivStmtRedirect", New Processors.FIAAnnivStmtRedirect))
        End Sub
