...
Imports Se2.ISCORSP.Client.GLCO.MaturityDateLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.MaturityDateLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("MaturityDateLetter", New Processors.MaturityDateLetter))
            Processors.Add(New ProcessorNV("MaturityDateLetterRedirect", New Processors.MaturityDateLetterRedirect))
        End Sub
