...
Namespace Se2.ISCORSP.Client.GLCO.MaturityDateLetter.CLM
...
#Region " POPULATION FUNCTIONS "
        ...
        Public Function LETTER_SERV_DESC(ByVal value As Se2Args) As String
            Dim retval As String
            Dim NonLTC_PLN() As String

            NonLTC_PLN = {"728", "732", "753", "754", "755", "756", "757", "758", "759", "772", "883", "887"}

            'If Se2Source.PLN_CODE = "728" Or Se2Source.PLN_CODE = "732" Or Se2Source.PLN_CODE = "753" Or Se2Source.PLN_CODE = "754" Or Se2Source.PLN_CODE = "755" Or Se2Source.PLN_CODE = "756" Or Se2Source.PLN_CODE = "757" Or Se2Source.PLN_CODE = "758" Or Se2Source.PLN_CODE = "759" Or Se2Source.PLN_CODE = "772" Then
            'retval = "Maturity Letter Non LTC"
            If NonLTC_PLN.Contains(Se2Source.PLN_CODE) Then
                retval = "Maturity Letter Non LTC"
            ElseIf Se2Source.LTC_RIDER_FLAG = "Y" Then
                retval = "Maturity Letter LTC"
            ElseIf Se2Source.LTC_RIDER_FLAG = "N" Then
                retval = "Maturity Letter Non LTC"
            Else retval = "Maturity Letter"
            End If
...
#Region " POPULATION FUNCTIONS "
        ...
        Public Function GetEmailAddress(ByVal value As Se2Args) As Object
            ...
            If CBool(Se2Source.MAIL_FLAG) Then
                ...
                StoreEmail.addParms("@DocumentType", "MATDT")
