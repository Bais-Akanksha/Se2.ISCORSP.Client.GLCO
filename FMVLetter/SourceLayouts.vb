...
Namespace Se2.ISCORSP.Client.GLCO.FMVLetter.SourceLayouts
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property RELATED_CONT As String
            ...
            End Get
        End Property
        Public ReadOnly Property RMD_RESV_AMT As String
            Get
                Return Values(FieldList.RMD_RESV_AMT)
            End Get
        End Property
        Public ReadOnly Property PRIOR_YEAR_ACCT_VAL As String
            ...
            End Get
        End Property
        Public ReadOnly Property DISB_AGE As String
            Get
                Return Values(FieldList.DISB_AGE)
            End Get
        End Property
