...
Imports Se2.ISCORSP.Client.GLCO.FMVLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.FMVLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("FMVLetter", New Processors.FMVLetter))
            Processors.Add(New ProcessorNV("FMVLetterRedirect", New Processors.FMVLetterRedirect))
        End Sub
