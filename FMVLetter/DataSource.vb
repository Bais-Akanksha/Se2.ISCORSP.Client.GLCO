...
Namespace Se2.ISCORSP.Client.GLCO.FMVLetter.DataSource
...
#Region " CONSTRUCTORS "
        ...
        Public Sub New(ByVal Args As Se2CmdArgs)
            ...
            DataColumn = 1
            'This code is added to support Pre-Prod for RMD.
            'Have Prod support run with InterfaceKey of RMDPRE and it will grab the data from Dev instead of PROD
            If cmdArgs.INTERFACEKEY = "RMDPRE" Then
                DataLocation = "Server=TOPSQLDB01D;Database=InterfaceDataStore;Integrated Security=SSPI;"
            End If
            SetParameters()
        End Sub
...
#End Region
        ...
        Public Overrides Sub SetParameters()
            ...
            GroupID = "181"
            Cmpy = "CORSP"
            If cmdArgs.PROCESSOR = "FMVLetterRedirect" Then
                Flag = "U"
            End If
            ...
            Parms.Add(New SqlClient.SqlParameter("@ClientProcedure", "GLCO_FMVLetter"))
