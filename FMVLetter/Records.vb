...
Namespace Se2.ISCORSP.Client.GLCO.FMVLetter.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("POL_SERVICE_DESC", "S:Annual FMV Letter"))
                ...
                .Add(New FieldDef("POL_DOC_TYPE_ID", "S:FMVLT"))
                .Add(New FieldDef("POL_FMV_AGE", "S:75"))
                .Add(New FieldDef("POL_NUMBER_TWO", "RELATED_CONT"))
                .Add(New FieldDef("POL_FAIR_MKT_VAL", "F:FAIR_MKT_VAL"))
                .Add(New FieldDef("POL_LETTER_YEAR", "F:GET_PREV_YR"))
                .Add(New FieldDef("POL_DISB_AGE", "DISB_AGE"))
            End With
        End Sub
#End Region
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property POL_SYS_CODE As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property POL_DOC_TYPE_ID As FieldDef
            Get
                Return Fields(FieldList.POL_DOC_TYPE_ID)
            End Get
        End Property
        Public ReadOnly Property POL_FMV_AGE As FieldDef
            Get
                Return Fields(FieldList.POL_FMV_AGE)
            End Get
        End Property
        Public ReadOnly Property POL_NUMBER_TWO As FieldDef
            Get
                Return Fields(FieldList.POL_NUMBER_TWO)
            End Get
        End Property
        Public ReadOnly Property POL_FAIR_MKT_VAL As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property POL_LETTER_YEAR As FieldDef
            Get
                Return Fields(FieldList.POL_LETTER_YEAR)
            End Get
        End Property
        Public ReadOnly Property POL_DISB_AGE As FieldDef
            Get
                Return Fields(FieldList.POL_DISB_AGE)
            End Get
        End Property
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("PVAL_RESV_AMT", "F:RESV_AMT"))
            End With
        End Sub
#End Region
