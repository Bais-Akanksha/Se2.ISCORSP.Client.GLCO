...
Imports Se2.ISCORSP.Client.GLCO.WaivePremiumLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.WaivePremiumLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("WaivePremiumLetter", New Processors.WaivePremiumLetter))
            Processors.Add(New ProcessorNV("WaivePremiumLetterRedirect", New Processors.WaivePremiumLetterRedirect))
        End Sub
