...
Imports Se2.ISCORSP.Client.GLCO.FIAADLStopBenefitLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.FIAADLStopBenefitLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("FIAADLStopBenefitLetter", New Processors.FIAADLStopBenefitLetter))
            Processors.Add(New ProcessorNV("FIAADLStopBenefitLetterRedirect", New Processors.FIAADLStopBenefitLetterRedirect))
        End Sub
