...
Namespace Se2.ISCORSP.Client.GLCO.FIAADLStopBenefitLetter.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("POL_SERVICE_DESC", "S:Benefit Stop"))
                ...
                .Add(New FieldDef("POL_DOC_TYPE", "S:ADLEND"))
            End With
        End Sub
#End Region
