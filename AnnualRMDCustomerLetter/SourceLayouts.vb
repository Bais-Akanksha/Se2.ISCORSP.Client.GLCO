...
Namespace Se2.ISCORSP.Client.GLCO.AnnualRMDCustomerLetter.SourceLayouts
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property PRCSSNG_CO As String
            ...
            End Get
        End Property
        Public ReadOnly Property PRDCT_MKTG_NAME As String
            Get
                Return Values(FieldList.PRDCT_MKTG_NAME)
            End Get
        End Property
        Public ReadOnly Property RESIDENCE_STATE As String
            Get
                Return Values(FieldList.RESIDENCE_STATE)
            End Get
        End Property
        Public ReadOnly Property SSW_IND As Integer
            Get
                Return Convert.ToInt32(Values(FieldList.SSW_IND))
            End Get
        End Property
        Public ReadOnly Property WATCH_LIST As String
            Get
                Return Values(FieldList.WATCH_LIST)
            End Get
        End Property
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property ADDRESS4 As String
            Get
                Return Values(FieldList.ADDRESS4)
            End Get
        End Property
        ...
        Public ReadOnly Property HOUSE_ACCOUNT_INDICATOR As String
            Get
                Return Values(FieldList.HOUSE_ACCOUNT_INDICATOR)
            End Get
        End Property
#End Region
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property RMD_RESV_AMT As Decimal
            ...
            End Get
        End Property
        Public ReadOnly Property RMD_RATE As Decimal
            Get
                Return CType(Values(FieldList.RMD_RATE), Decimal)
            End Get
        End Property
        Public ReadOnly Property FAIR_MKT_VAL As Decimal
            Get
                Return CType(Values(FieldList.FAIR_MKT_VAL), Decimal)
            End Get
        End Property
