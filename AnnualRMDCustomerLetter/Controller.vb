...
Imports Se2.ISCORSP.Client.GLCO.AnnualRMDCustomerLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.AnnualRMDCustomerLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("AnnualRMDCustomerLetter", New Processors.AnnualRMDCustomerLetter))
            Processors.Add(New ProcessorNV("AnnualRMDCustomerLetterRedirect", New Processors.AnnualRMDCustomerLetterRedirect))
        End Sub
