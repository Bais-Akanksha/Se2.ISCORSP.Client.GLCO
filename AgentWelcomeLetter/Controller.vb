...
Imports Se2.ISCORSP.Client.GLCO.AgentWelcomeLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.AgentWelcomeLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("AgentWelcomeLetter", New Processors.AgentWelcomeLetter))
            Processors.Add(New ProcessorNV("AgentWelcomeLetterRedirect", New Processors.AgentWelcomeLetterRedirect))
        End Sub
