...
Namespace Se2.ISCORSP.Client.GLCO.AgentWelcomeLetter.SourceLayouts
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property PRCSSNG_CO As String
            ...
            End Get
        End Property
        Public ReadOnly Property MAT_DATE As Date
            Get
                Return CDate(Values(FieldList.MAT_DATE))
            End Get
        End Property
        Public ReadOnly Property PREM_AMT As Decimal
            Get
                Return Convert.ToDecimal(Values(FieldList.PREM_AMT))
            End Get
        End Property
        Public ReadOnly Property GTY_PRD As Decimal
            Get
                Return Convert.ToDecimal(Values(FieldList.GTY_PRD))
            End Get
        End Property
        Public ReadOnly Property ADJUSTED_RATE As Decimal
            Get
                Return Convert.ToDecimal(Values(FieldList.ADJUSTED_RATE))
            End Get
        End Property
        Public ReadOnly Property LF_DIV_GUAR_PERD As String
            Get
                Return Values(FieldList.LF_DIV_GUAR_PERD)
            End Get
        End Property
