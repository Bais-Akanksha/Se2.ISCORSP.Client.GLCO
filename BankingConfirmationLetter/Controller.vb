...
Imports Se2.ISCORSP.Client.GLCO.BankingConfirmationLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.BankingConfirmationLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("BankingConfirmationLetter", New Processors.BankingConfirmationLetter))
            Processors.Add(New ProcessorNV("BankingConfirmationLetterRedirect", New Processors.BankingConfirmationLetterRedirect))
        End Sub
