...
Namespace Se2.ISCORSP.Client.GLCO.BankingConfirmationLetter.SourceLayouts
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property SYSTEM_CODE As String
            ...
            End Get
        End Property
        Public ReadOnly Property CONT_YEAR As String
            Get
                Return Values(FieldList.CONT_YEAR)
            End Get
        End Property
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property OPT_DESC As String
            ...
            End Get
        End Property
        Public ReadOnly Property BANK_NUM As String
            Get
                Return Values(FieldList.BANK_NUM)
            End Get
        End Property
