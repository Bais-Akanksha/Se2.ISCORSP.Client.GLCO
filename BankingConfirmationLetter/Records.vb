...
Namespace Se2.ISCORSP.Client.GLCO.BankingConfirmationLetter.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("POL_SERVICE_DESC", "S:Banking Confirmation Letter"))
                ...
                .Add(New FieldDef("POL_DOC_TYPE", "S:NBILTR"))
                ...
                .Add(New FieldDef("POL_CONT_YEAR", "CONT_YEAR"))
                ' .Add(New FieldDef("POL_BANK_NUM", "BANK_NUM"))
            End With
        End Sub
#End Region
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property POL_SYS_CODE As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property POL_CONT_YEAR As FieldDef
            Get
                Return Fields(FieldList.POL_CONT_YEAR)
            End Get
        End Property
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("ROL_BANK_NUM", "F:BANK_ACCOUNT_NUMBER"))
            End With
        End Sub
#End Region
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property ROL_BANK_NUM As FieldDef
            Get
                Return Fields(FieldList.ROL_BANK_NUM)
            End Get
        End Property
