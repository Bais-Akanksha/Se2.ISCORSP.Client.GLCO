...
Namespace Se2.ISCORSP.Client.GLCO.BankingConfirmationLetter.CLM
...
#Region " POPULATION FUNCTIONS "
        ...
        Public Function GetEmailAddress(ByVal value As Se2Args) As Object
            ...
            If CBool(Se2Source.MAIL_FLAG) Then
                ...
                StoreEmail.addParms("@DocumentType", "NBILTR")
        ...
        Public Function BANK_ACCOUNT_NUMBER(ByVal value As Se2Args) As String

            Dim retval As String = Se2Source.BANK_NUM.ToString
            If retval.Length > 4 Then
                retval = retval.Substring(retval.Length - 4).PadLeft(retval.Length, "X")
