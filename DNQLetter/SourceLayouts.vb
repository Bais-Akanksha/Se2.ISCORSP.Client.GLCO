...
Namespace Se2.ISCORSP.Client.GLCO.DNQLetter.SourceLayouts
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property SYSTEM_CODE As String
            ...
            End Get
        End Property
        Public ReadOnly Property PREM_MODE As String
            Get
                Return Values(FieldList.PREM_MODE)
            End Get
        End Property

        Public ReadOnly Property REDUCED_BEN_AMT As Decimal
            Get
                Return Convert.ToDecimal(Values(FieldList.REDUCED_BEN_AMT))
            End Get
        End Property
        Public ReadOnly Property EN_BEN_INC_AMT As Decimal
            Get
                Return Convert.ToDecimal(Values(FieldList.EN_BEN_INC_AMT))
            End Get
        End Property
