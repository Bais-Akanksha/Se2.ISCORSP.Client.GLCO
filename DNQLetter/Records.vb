...
Namespace Se2.ISCORSP.Client.GLCO.DNQLetter.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("POL_SERVICE_NAME", "S:Letter"))
                .Add(New FieldDef("POL_SERVICE_DESC", "S:Do Not Qualify"))
                ...
                .Add(New FieldDef("POL_DOC_TYPE", "S:ADLLTR"))
                .Add(New FieldDef("POL_SYS_CODE", "SYSTEM_CODE"))
                .Add(New FieldDef("POL_LIFETIME_PYMNT_AMT", 0, FieldType.Number, "0.00", "F:EN_BEN_INC_AMT"))
                .Add(New FieldDef("POL_PREM_MODE", "F:PREM_FREQ"))
                .Add(New FieldDef("POL_LIFETIME_PYMNT_AMT2", 0, FieldType.Number, "0.00", "F:REDUCED_BEN_AMT"))
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property POL_PREM_MODE As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property POL_LIFETIME_PYMNT_AMT2 As FieldDef
            Get
                Return Fields(FieldList.POL_LIFETIME_PYMNT_AMT2)
            End Get
        End Property
