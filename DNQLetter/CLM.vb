...
Namespace Se2.ISCORSP.Client.GLCO.DNQLetter.CLM
...
#Region " POPULATION FUNCTIONS "
        ...
        Public Function PREM_FREQ(ByVal value As Se2Args) As String
            Dim retval As String

            Select Case Se2Source.PREM_MODE.ToUpper
                Case "A"
                    retval = "annually"
                Case "B"
                    retval = "bi - monthly"
        ...
        End Function
        Public Function REDUCED_BEN_AMT(ByVal value As Se2Args) As Object
            Dim retVal As String
            'Dim REDUCED_BEN_AMOUNT As Integer = CInt((Se2Source.REDUCED_BEN_AMT).ToString)
            Dim REDUCED_BEN_AMOUNT As String = CType(Se2Source.REDUCED_BEN_AMT, String)

            Select Case Se2Source.PREM_MODE.ToUpper
                Case "A"
                    retVal = REDUCED_BEN_AMOUNT.ToString
                Case "B"
                    retVal = (REDUCED_BEN_AMOUNT / 24).ToString
                Case "S", "SA"
                    retVal = (REDUCED_BEN_AMOUNT / 2).ToString
                Case "Q"
                    retVal = (REDUCED_BEN_AMOUNT / 4).ToString
                Case "M"
                    retVal = (REDUCED_BEN_AMOUNT / 12).ToString
                Case Else
                    retVal = ""
            End Select
        ...
        End Function
        Public Function EN_BEN_INC_AMT(ByVal value As Se2Args) As Object
            Dim retVal As String
            Dim ENHAN_BEN_AMOUNT As String = CType(Se2Source.EN_BEN_INC_AMT, String)   'CInt(CDbl((Se2Source.EN_BEN_INC_AMT).ToString))

            Select Case Se2Source.PREM_MODE.ToUpper
                Case "A"
                    retVal = ENHAN_BEN_AMOUNT.ToString
                Case "B"
                    retVal = (ENHAN_BEN_AMOUNT / 24).ToString
                Case "S", "SA"
                    retVal = (ENHAN_BEN_AMOUNT / 2).ToString
                Case "Q"
                    retVal = (ENHAN_BEN_AMOUNT / 4).ToString
                Case "M"
                    retVal = (ENHAN_BEN_AMOUNT / 12).ToString
                Case Else
                    retVal = ""
            End Select
...
#Region " POPULATION FUNCTIONS "
        ...
        Public Function GetEmailAddress(ByVal value As Se2Args) As Object
            ...
            If CBool(Se2Source.MAIL_FLAG) Then
                ...
                StoreEmail.addParms("@DocumentType", "REPLTR")
