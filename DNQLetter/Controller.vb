...
Imports Se2.ISCORSP.Client.GLCO.DNQLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.DNQLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("DNQLetter", New Processors.DNQLetter))
            Processors.Add(New ProcessorNV("DNQLetterRedirect", New Processors.DNQLetterRedirect))
        End Sub
