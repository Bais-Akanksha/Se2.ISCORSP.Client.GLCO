...
Namespace Se2.ISCORSP.Client.GLCO.FIAADLStartBenefitLetter.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("POL_SERVICE_DESC", "S:Start Benefit"))
                ...
                .Add(New FieldDef("POL_DOC_TYPE", "S:ADLBEG"))
                .Add(New FieldDef("POL_START_DATE", "RENEWAL_DATE"))
