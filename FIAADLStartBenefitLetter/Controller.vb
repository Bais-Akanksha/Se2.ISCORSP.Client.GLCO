...
Imports Se2.ISCORSP.Client.GLCO.FIAADLStartBenefitLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.FIAADLStartBenefitLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("FIAADLStartBenefitLetter", New Processors.FIAADLStartBenefitLetter))
            Processors.Add(New ProcessorNV("FIAADLStartBenefitLetterRedirect", New Processors.FIAADLStartBenefitLetterRedirect))
        End Sub
