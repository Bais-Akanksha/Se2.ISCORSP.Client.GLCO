...
Namespace Se2.ISCORSP.Client.GLCO.FIAADL30DayLetter.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("POL_SERVICE_DESC", "S:30 day Recertification Letter"))
                ...
                .Add(New FieldDef("POL_DOC_TYPE", "S:ADL30"))
