...
Imports Se2.ISCORSP.Client.GLCO.FIAADL30DayLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.FIAADL30DayLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("FIAADL30DayLetter", New Processors.FIAADL30DayLetter))
            Processors.Add(New ProcessorNV("FIAADL30DayLetterRedirect", New Processors.FIAADL30DayLetterRedirect))
        End Sub
