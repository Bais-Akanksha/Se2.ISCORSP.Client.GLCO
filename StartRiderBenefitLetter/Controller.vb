...
Imports Se2.ISCORSP.Client.GLCO.StartRiderBenefitLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.StartRiderBenefitLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("StartRiderBenefitLetter", New Processors.StartRiderBenefitLetter))
            Processors.Add(New ProcessorNV("StartRiderBenefitLetterRedirect", New Processors.StartRiderBenefitLetterRedirect))
        End Sub
