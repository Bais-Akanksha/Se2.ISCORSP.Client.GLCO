...
Namespace Se2.ISCORSP.Client.GLCO.StartRiderBenefitLetter.Records
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("POL_SERVICE_DESC", "S:Rider Start Benefit Letter"))
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("PVAL_TXN_EFF_DATE", "", FieldType.Date, "yyyy-MM-dd", "TX_TXN_DATE"))
                .Add(New FieldDef("PVAL_ANNUAL_LIMIT", "F:ANNUAL_LIMIT_PYMT"))
                .Add(New FieldDef("PVAL_SWP_FREQ", "F:SWP_FREQ"))
                .Add(New FieldDef("PVAL_GMWB_AMT_TYPE", "F:GMWB_AMT_TYPE"))
            End With
        End Sub
#End Region
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property PVAL_TXN_EFF_DATE As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property PVAL_ANNUAL_LIMIT As FieldDef
            Get
                Return Fields(FieldList.PVAL_ANNUAL_LIMIT)
            End Get
        End Property
        Public ReadOnly Property PVAL_SWP_FREQ As FieldDef
            Get
                Return Fields(FieldList.PVAL_SWP_FREQ)
            End Get
        End Property
        Public ReadOnly Property PVAL_GMWB_AMT_TYPE As FieldDef
            Get
                Return Fields(FieldList.PVAL_GMWB_AMT_TYPE)
            End Get
        End Property
