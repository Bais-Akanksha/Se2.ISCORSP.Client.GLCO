...
Namespace Se2.ISCORSP.Client.GLCO.StartRiderBenefitLetter.SourceLayouts
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property PRCSSNG_CO As String
            ...
            End Get
        End Property
        Public ReadOnly Property TX_GWB_ANNUAL_LIMIT As Decimal
            Get
                Return CType(Values(FieldList.TX_GWB_ANNUAL_LIMIT), Decimal)
            End Get
        End Property
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property CVG_ID As String
            ...
            End Get
        End Property
        Public ReadOnly Property TX_TXN_DATE As String
            Get
                Return Values(FieldList.TX_TXN_DATE)
            End Get
        End Property
        Public ReadOnly Property TX_GWB_ANNUAL_LIMIT As Decimal
            Get
            ...
            End Get
        End Property
        Public ReadOnly Property SP_MODE_CODE As String
            Get
                Return Values(FieldList.SP_MODE_CODE)
            End Get
        End Property
        Public ReadOnly Property TX_AMT_TYPE As String
            Get
                Return Values(FieldList.TX_AMT_TYPE)
            End Get
        End Property
