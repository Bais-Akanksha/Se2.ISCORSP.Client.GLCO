...
Imports Se2.ISCORSP.Client.GLCO.MYGAAnnivStmt.Processors

Namespace Se2.ISCORSP.Client.GLCO.MYGAAnnivStmt
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("MYGAAnnivStmt", New Processors.MYGAAnnivStmt))
            Processors.Add(New ProcessorNV("MYGAAnnivStmtRedirect", New Processors.MYGAAnnivStmtRedirect))
        End Sub
