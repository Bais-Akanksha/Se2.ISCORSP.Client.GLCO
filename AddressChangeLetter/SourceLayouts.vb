...
Namespace Se2.ISCORSP.Client.GLCO.AddressChangeLetter.SourceLayouts
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property OPT_DESC As String
            ...
            End Get
        End Property
        Public ReadOnly Property OLD_ADDRESS1 As String
			Get
				Return Values(FieldList.OLD_ADDRESS1)
			End Get
		End Property
		Public ReadOnly Property OLD_ADDRESS2 As String
			Get
				Return Values(FieldList.OLD_ADDRESS2)
			End Get
		End Property
		Public ReadOnly Property OLD_ADDRESS3 As String
			Get
				Return Values(FieldList.OLD_ADDRESS3)
			End Get
		End Property
		Public ReadOnly Property OLD_CITY As String
			Get
				Return Values(FieldList.OLD_CITY)
			End Get
		End Property
		Public ReadOnly Property OLD_STATE_CODE As String
			Get
				Return Values(FieldList.OLD_STATE_CODE)
			End Get
		End Property
		Public ReadOnly Property OLD_ZIP As String
			Get
				Return Values(FieldList.OLD_ZIP)
			End Get
		End Property
		Public ReadOnly Property OLD_ZIP_SUFFIX As String
			Get
				Return Values(FieldList.OLD_ZIP_SUFFIX)
			End Get
		End Property
		Public ReadOnly Property OLD_CTRY_CODE As String
			Get
				Return Values(FieldList.OLD_CTRY_CODE)
			End Get
		End Property
		Public ReadOnly Property OLD_ADDRESS_TYPE As String
			Get
				Return Values(FieldList.OLD_ADDRESS_TYPE)
			End Get
		End Property
#End Region
