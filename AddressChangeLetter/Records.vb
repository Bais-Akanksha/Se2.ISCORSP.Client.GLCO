...
Namespace Se2.ISCORSP.Client.GLCO.AddressChangeLetter.Records
...
#Region " Constructors "
				...
				Public Sub New()
						...
						Me.NodeParent = "AddressChangeLetter"
				End Sub
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
            ...
            With Fields
                ...
                .Add(New FieldDef("Service_Desc", "S:Address Change Letter"))
                ...
                .Add(New FieldDef("CSR_Name", "S:TESTER"))
...
#Region " CONSTRUCTORS "
        ...
        Private Sub Initialize()
			...
			With Fields
                ...
                .Add(New FieldDef("Old_Addr_Line_1", "OLD_ADDRESS1"))
				.Add(New FieldDef("Old_Addr_Line_2", "OLD_ADDRESS2"))
				.Add(New FieldDef("Old_Addr_Line_3", "OLD_ADDRESS3"))
				.Add(New FieldDef("Old_City", "OLD_CITY"))
				.Add(New FieldDef("Old_State", "OLD_STATE_CODE"))
				.Add(New FieldDef("Old_Zip", "F:FULL_OLD_ZIP_CODE"))
				.Add(New FieldDef("Old_Address_Type", "OLD_ADDRESS_TYPE"))
			End With
		End Sub
#End Region
...
#Region " PROPERTIES "
        ...
        Public ReadOnly Property Delivery_Destination_Type As FieldDef
            ...
            End Get
        End Property
        Public ReadOnly Property Old_Addr_Line_1 As FieldDef
			Get
				Return Fields(FieldList.Old_Addr_Line_1)
			End Get
		End Property
		Public ReadOnly Property Old_Addr_Line_2 As FieldDef
			Get
				Return Fields(FieldList.Old_Addr_Line_2)
			End Get
		End Property
		Public ReadOnly Property Old_Addr_Line_3 As FieldDef
			Get
				Return Fields(FieldList.Old_Addr_Line_3)
			End Get
		End Property
		Public ReadOnly Property Old_City As FieldDef
			Get
				Return Fields(FieldList.Old_City)
			End Get
		End Property
		Public ReadOnly Property Old_State As FieldDef
			Get
				Return Fields(FieldList.Old_State)
			End Get
		End Property
		Public ReadOnly Property Old_Zip As FieldDef
			Get
				Return Fields(FieldList.Old_Zip)
			End Get
		End Property
		Public ReadOnly Property Old_Address_Type As FieldDef
			Get
				Return Fields(FieldList.Old_Address_Type)
			End Get
		End Property
#End Region
