...
Namespace Se2.ISCORSP.Client.GLCO.AddressChangeLetter.CLM
...
#Region " POPULATION FUNCTIONS "
		...
		Public Function FULL_OLD_ZIP_CODE(ByVal value As Se2Args) As String

			Dim retval As String

			retval = Se2Source.OLD_ZIP & Se2Source.OLD_ZIP_SUFFIX
        ...
        Public Function GetEmailAddress(ByVal value As Se2Args) As Object
            ...
            If CBool(Se2Source.MAIL_FLAG) Then
                ...
                StoreEmail.addParms("@DocumentType", "ADCHN")
