...
Imports Se2.ISCORSP.Client.GLCO.AddressChangeLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.AddressChangeLetter
		...
		Public Class Controller
				...
				Public Sub New()
						MyBase.New()
			Processors.Add(New ProcessorNV("AddressChangeLetter", New Processors.AddressChangeLetter))
			Processors.Add(New ProcessorNV("AddressChangeLetterRedirect", New Processors.AddressChangeLetterRedirect))
		End Sub
