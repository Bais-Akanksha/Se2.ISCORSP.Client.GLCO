...
Imports Se2.ISCORSP.Client.GLCO.ADLRecertifyLetter.Processors

Namespace Se2.ISCORSP.Client.GLCO.ADLRecertifyLetter
    ...
    Public Class Controller
        ...
        Public Sub New()
            MyBase.New()
            Processors.Add(New ProcessorNV("ADLRecertifyLetter", New Processors.ADLRecertifyLetter))
            Processors.Add(New ProcessorNV("ADLRecertifyLetterRedirect", New Processors.ADLRecertifyLetterRedirect))
        End Sub
