...
Namespace Se2.ISCORSP.Client.GLCO.ADLRecertifyLetter.SourceLayouts
...
#Region " PUBLIC PROPERTIES "
        ...
        Public ReadOnly Property PRCSSNG_CO As String
            ...
            End Get
        End Property
        Public ReadOnly Property GWB_ANNUAL_LIMIT As Decimal
            Get
                Return Convert.ToDecimal(Values(FieldList.GWB_ANNUAL_LIMIT))
            End Get
        End Property
        Public ReadOnly Property SP_MODE_CODE As String
            ...
            End Get
        End Property
        Public ReadOnly Property ADDTL_BEN_START_DATE As Date
            Get
                Return CDate(Values(FieldList.ADDTL_BEN_START_DATE))
            End Get
        End Property
#End Region
